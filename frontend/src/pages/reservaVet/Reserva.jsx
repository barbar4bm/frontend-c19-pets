            ...
            <body>
                <Form className='tarjeta' style={{ height: 1000, width: 700 }} onSubmit={handleSubmit(saveAppointment)}>
                    ...
                    <Form.Field>
                        ...
                        <input type="text" name="summary"  {...register("summary", { required: true, maxLength: 50, minLength: 2 })} />
                    ...
                    <Form.Field>
                        <label>Donde ?</label>
                        <input placeholder='Clinica Puertas del mar' type="text" name="location"  {...register("location", { required: true, maxLength: 40, minLength: 2 })} />
                    </Form.Field>
